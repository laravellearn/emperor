                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview {{ Request::routeIs(['admin.settings.footer.label','admin.settings.footer.social','admin.settings.footer.logo']) ? 'active' : ''}}">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a {{ Request::routeIs(['admin.settings.footer.label','admin.settings.footer.social','admin.settings.footer.logo']) ? "style=color:#54c6d0" : '' }} href="{{ route('admin.settings.footer.label') }}">تنظیمات فوتر</a></li>
                            <!-- استان و شهر و ... -  -->
