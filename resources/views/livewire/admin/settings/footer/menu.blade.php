                                ...
                                <div class="d-sm-flex">
                                    ...
                                    <div class="mail-body--area">
                                        <div class="container-fluid">
                                            <div class="row">
                                                @can('settings-footer-menu-create')
                                                ...
                                                @cannot('settings-footer-menu-create')
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        @can('settings-footer-menu-edit')
                                                                                            ...
                                                                                            @endif
                                                                                        @endcan
                                                                                        @cannot('settings-footer-menu-edit')
                                                                                            @if ($menu->isActive == 1)
                                                                                                <span
                                                                                                    style="cursor:pointer"><span
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        @endcan
                                                                                        @can('settings-footer-menu-delete')
                                                                                            <button
