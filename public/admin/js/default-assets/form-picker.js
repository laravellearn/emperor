! function (r) {
    ...
    t.prototype.init = function () {
        r("#basic-colorpicker").colorpicker(), r("#hexa-colorpicker").colorpicker({
            format: "auto"
        }), r("#component-colorpicker").colorpicker({
            format: null
        }), r("#horizontal-colorpicker").colorpicker({
            horizontal: !0
        }), r("#inline-colorpicker").colorpicker({
            color: "#DD0F20",
            inline: !0,
            container: !0
        }), r(".clockpicker").clockpicker({
            donetext: "تنظیم"
        }), r("#single-input").clockpicker({
            placement: "bottom",
            align: "left",
            autoclose: !0,
            default: "now"
